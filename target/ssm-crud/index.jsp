                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="empName" class="form-control"
                                   ...
                                   placeholder="empName" checked="checked"/>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            $("<tr></tr>").append(checkBoxTd).append(empIdTd).append(empNameTd).append(genderTd).append(emailTd)
                .append(deptNameId).append(btnTd).appendTo("#emps_table tbody");
        })
    }
    ...
    function validate_add_form() {
        ...
        if (!regName.test(empName)) {
            ...
            // $("#empName_add_input").next("span").text("用户名可以是2-5位中文或者6-16位英文和数组的组合");
            show_validate_msg("#empName_add_input", "error", "用户名可以是3-5位中文或者6-16位英文和数组的组合");
            return false;
        } else {
        ...
        if (!regEmail.test(email)) {
            ...
            show_validate_msg("#email_add_input", "error", "邮箱格式不正确1");
            return false;
        } else {
    ...
    $(document).on("click", ".edit_btn", function () {
        // alert("edit");
        $("#empUpdateModal form").find("#email_update_input").parent().removeClass("has_success has-error");
    ...
    $("#emp_update_btn").click(function () {
        ...
        var regEmail = /^([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/;
        if (!regEmail.test(email)) {
            show_validate_msg("#email_update_input", "error", "邮箱格式不正确1");
            return false;
        } else {
