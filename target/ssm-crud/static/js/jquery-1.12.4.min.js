...
!function (a, b) {
    ...
    var t = function (a) {
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + 1 * new Date,
            v = a.document, w = 0, x = 0, y = ga(), z = ga(), A = ga(), B = function (a, b) {
                return a === b && (l = !0), 0
            }, C = 1 << 31, D = {}.hasOwnProperty, E = [], F = E.pop, G = E.push, H = E.push,
            I = E.slice, J = function (a, b) {
        ...
        function xa(a, b) {
            var c = b.length > 0, e = a.length > 0, f = function (f, g, h, i, k) {
                var l, o, q, r = 0, s = "0", t = f && [], u = [], v = j,
                    x = f || e && d.find.TAG("*", k), y = w += null == v ? 1 : Math.random() || .1,
                    z = x.length;
    ...
    n.Callbacks = function (a) {
        ...
        Deferred: function (a) {
            ...
            var b = 0, c = e.call(arguments), d = c.length,
    ...
    !function () {
        var a = d.createElement("div"), b = d.createDocumentFragment(),
    ...
    var ka = /^(?:input|select|textarea)$/i, la = /^key/,
    ...
    n.event = {
        ...
        dispatch: function (a) {
            a = n.event.fix(a);
            var b, c, d, f, g, h = [], i = e.call(arguments),
    ...
    var Na = /^margin/, Oa = new RegExp("^(" + T + ")(?!px)[a-z%]+$", "i"),
        Pa = function (a, b, c, d) {
            var e, f, g = {};
    ...
    n.Animation = n.extend(qb, {
        ...
        var a, b = d.createElement("input"), c = d.createElement("div"),
            e = d.createElement("select"), f = e.appendChild(d.createElement("option"));
    ...
    var tb, ub, vb = n.expr.attrHandle, wb = /^(?:checked|selected)$/i, xb = l.getSetAttribute,
        yb = l.input;
    n.fn.extend({
        attr: function (a, b) {
    ...
    var Hb = /#.*$/, Ib = /([?&])_=[^&]*/, Jb = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Kb = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Lb = /^(?:GET|HEAD)$/,
        Mb = /^\/\//, Nb = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Ob = {},
        Pb = {}, Qb = "*/".concat("*"), Rb = Db.href, Sb = Nb.exec(Rb.toLowerCase()) || [];
    ...
    n.extend({
        ...
        ajax: function (b, c) {
            ...
            var d, e, f, g, h, i, j, k, l = n.ajaxSetup({}, c), m = l.context || l,
                ...
                q = n.Callbacks("once memory"), r = l.statusCode || {}, s = {}, t = {}, u = 0,
                v = "canceled", w = {
